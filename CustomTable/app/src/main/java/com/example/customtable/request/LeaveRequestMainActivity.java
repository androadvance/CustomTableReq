...
public class LeaveRequestMainActivity extends AppCompatActivity {
    ...
    public static List<LeaveRequestListItem> listitems;
    public static LeaveRequestAdapter adapter;
    List<ListItemHeader> listitems1;
    private ListAdapterHeader adapter1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listitems1 = new ArrayList<ListItemHeader>();
        listitems1.add(new ListItemHeader("EmpNo", "Name", "Team", "Dept", "Designation", "Unit", "Leave Date", "Session", "Purpose", "Remarks"));
        adapter1 = new ListAdapterHeader(getApplicationContext(), (ArrayList<ListItemHeader>) listitems1);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < listitems.size(); i++) {
                    ...
                    LeaveRequestListItem item = listitems.get(i);

                    if (item.session == null) {
                        Toast.makeText(LeaveRequestMainActivity.this, "Please select session", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    ...
                    if (item.purpose == null) {
                        Toast.makeText(LeaveRequestMainActivity.this, "Please select Purpose", Toast.LENGTH_SHORT).show();
                        return;
                    }
                ...
                for (int i = 0; i < listitems.size(); i++) {
                    ...
                    s_team = item.team;
                    s_dept = item.dept;
                    s_desgination = item.designation;
                    s_unit = item.unit;
    ...
    public class getLeaveEntryDetails extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            p = new SweetAlertDialog(LeaveRequestMainActivity.this, SweetAlertDialog.PROGRESS_TYPE);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equals("Invalid Date...Please select valid date")) {
                ...
                Toast.makeText(LeaveRequestMainActivity.this, "Invalid date", Toast.LENGTH_SHORT).show();
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    try {
                        ...
                        listitems.add(new LeaveRequestListItem(EmpNo, Name, Team, Dept, Designation, Unit, Date, session, purpose, remarks));

                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                }
                adapter = new LeaveRequestAdapter(getApplicationContext(), (ArrayList<LeaveRequestListItem>) listitems);
    ...
    public class insertEmpLeaveEntry extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String[] values = {params[0], params[1], params[2], params[3], params[4], params[5], params[6], params[7], params[8], params[9], params[10], params[11], params[12], params[13], params[14], SplashScreen.deviceid};
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equals("ok")) {
                ...
                sucess.show();
                Intent intent = new Intent(LeaveRequestMainActivity.this, HomeScreenActivity.class);
